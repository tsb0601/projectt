...
def patch_metadata():
    env_metadata = load_metadata("/home/bytetriper/tpu-env.txt") # modify this to your path
    network_endpoint_metadata = load_metadata("/home/bytetriper/worker-network-endpoints.txt")  # modify this to your path
